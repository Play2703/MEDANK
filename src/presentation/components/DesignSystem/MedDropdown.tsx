...
export interface MedDropdownOption {
  value: string;
  label: string;
}

export interface MedDropdownProps extends React.SelectHTMLAttributes<HTMLSelectElement> {
  label?: string;
  options: MedDropdownOption[];
  error?: string;
  helperText?: string;
}

export const MedDropdown: React.FC<MedDropdownProps> = ({
  label,
  options,
  error,
  helperText,
